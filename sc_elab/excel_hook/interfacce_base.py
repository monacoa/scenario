...
def bond_fitting_from_xls(control):
    ...
    if flag_loaded_rf == 0:
        ...
        interp_rf_model, curve_rf.ref_date)
        tkMessageBox.showinfo("Attenzione!!", msg0)
    ...
    flag_elab, res_elab = bf.compute_bond_fitting(bf_options_elab, dictPortfolio, data_zc_rf, data_zc_infl,
                                                  data_ts_infl, x0, x_bnd)
